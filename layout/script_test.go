...
func TestScriptOfSamples(t *testing.T) {
	cases := []struct {
		...
		{"Gujarati ka", '\u0A95', ScriptGujarati},
		{"Gurmukhi ka", '\u0A15', ScriptGurmukhi},
		{"Kannada ka", '\u0C95', ScriptKannada},
		{"Malayalam ka", '\u0D15', ScriptMalayalam},
		{"Oriya ka", '\u0B15', ScriptOriya},
		{"Telugu ka", '\u0C15', ScriptTelugu},
